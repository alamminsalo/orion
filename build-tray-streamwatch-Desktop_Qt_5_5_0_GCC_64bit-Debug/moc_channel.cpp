...
QT_MOC_LITERAL(3, 17, 11) // "iconUpdated"

    },
    "Channel\0updated\0\0iconUpdated"
};
...
void Channel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Channel::updated)) {
                *result = 0;
            }
        }
        {
            typedef void (Channel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Channel::iconUpdated)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Channel::updated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Channel::iconUpdated()
{
